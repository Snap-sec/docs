...
<Warning> New Organizations have demo data loaded by default. You can remove demo data by clicking on `Remove demo data` button on dashboard</Warning>
...
<p> Follow [this guide](/products/csm/articles/submit_report) to report vulnerabilities on specific assessment.</p>
### Accessing Reports
<p>
