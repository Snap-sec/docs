...
The Vulnerability Report Page includes key components such as:
- Technical description and impact assessment
...
<Tip>
For detailed information about working with vulnerability reports, see the [Vulnerability Reports](/products/csm/articles/vuln_reports) documentation.
</Tip>
